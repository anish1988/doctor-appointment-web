...
import pImg from '../../../images/man_avatar.jpg';
                    ...
                    <div class="patient-list_card_Bounds__0V3ES" data-testid="test_patientCard">
                        <Grid container-fluid="true" style={{display: 'flex'}}>
                            ...
                            <Grid style={{margin: '0px 4px',height:'25px'}}>
                                <div data-testid="test_patientThreeDots" id="A1LGOG3NI9P4" class="patient-list_dotImage__KkSQj">
...
<div className="">
          <IconButton
            ...
            size="small"
          >
            <Icon className="text-50">more_vert</Icon>
          </IconButton>
          <Menu
            id="actions-menu"
            anchorEl={anchorEl}
